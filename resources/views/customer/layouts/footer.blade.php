            ...
            <div class="footer-shipping pb-xs-0">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 pb-xs-45">
                        <div class="li-shipping-inner-box">
                            <div class="shipping-icon">
                                <img src="{{ asset('customer/images/shipping-icon/1.png') }}" alt="Shipping Icon">
                            </div>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 pb-xs-45">
                        <div class="li-shipping-inner-box">
                            <div class="shipping-icon">
                                <img src="{{ asset('customer/images/shipping-icon/2.png') }}" alt="Shipping Icon">
                            </div>
                            <div class="shipping-text">
                                <h2>Safe Payment</h2>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 pb-xs-45">
                        <div class="li-shipping-inner-box">
                            <div class="shipping-icon">
                                <img src="{{ asset('customer/images/shipping-icon/3.png') }}" alt="Shipping Icon">
                            </div>
                            <div class="shipping-text">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6">
                        <div class="li-shipping-inner-box last-child">
                            <div class="shipping-icon">
                                <img src="{{ asset('customer/images/shipping-icon/4.png') }}" alt="Shipping Icon">
                            </div>
                            <div class="shipping-text">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="payment text-center">
                        <a href="#">
                            <img src="{{ asset('customer/images/payment/1.png') }}" alt="">
                        </a>
                    </div>
