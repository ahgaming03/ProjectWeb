                        ...
                        <div class="col-12 d-flex justify-content-center align-items-center mt-1 mb-2">
                            <form action="{{ route('upload-image') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <input type="text" class="form-control form-control-sm" id="customerID" name="customerID"
                                    placeholder="ID" value="{{ $customer->customerID }}" readonly hidden>
                        ...
                        <div class="row">
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control form-control-sm" id="username" name="username"
                                    placeholder="Username"value="{{ $customer->username }}" disabled>
                                @error('username')
                                    <div class="text-danger mt-2">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control form-control-sm" id="email" name="email"
                                    placeholder="example@gmail.com" value="{{ $customer->email }}">
                                @error('email')
                                    <div class="text-danger mt-2">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="tel" class="form-control form-control-sm" id="phoneNumber"
                                    name="phoneNumber" placeholder="Phone number" value="{{ $customer->phoneNumber }}">
                                @error('phoneNumber')
                                    <div class="text-danger mt-2">
                                        {{ $message }}
                                    </div>
